...
- Modeling independent entities with state and behavior
- Synchronizing logical state with DOM representation
- Managing interaction through events and data attributes
- Resetting and reinitializing system state cleanly
- Building a small interactive system from scratch
...
The goal of this project is to explore interactive system design and build a foundation for simulating movement, collisions, and simple physics behaviors in the browser.
